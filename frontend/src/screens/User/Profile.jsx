...
const Profile = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.label}>
                Phone: <Text style={styles.value}>{userData?.phone || 'N/A'}</Text>
            </Text>
            <Text style={styles.label}>
                Address: <Text style={styles.value}>{userData?.address || 'N/A'}</Text>
            </Text>
            <Text style={styles.label}>
                City: <Text style={styles.value}>{userData?.city || 'N/A'}</Text>
            </Text>
            <Text style={styles.label}>
                Country: <Text style={styles.value}>{userData?.country || 'N/A'}</Text>
            </Text>
